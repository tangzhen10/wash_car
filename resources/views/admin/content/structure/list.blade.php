			...
			<article class="cl pd-20">
				...
				<div class="cl pd-5 bg-1 bk-gray mt-20">
					<span class="l">
						...
						<a href="javascript:;" onclick="document_type_add('添加文档类型','{{route('contentStructureForm')}}','1000','500')" class="btn btn-primary radius">
...
@section('js')
	...
	<script type="text/javascript">
		 ...
		 */
		/*管理员-增加*/
		function document_type_add(title, url, w, h) {
